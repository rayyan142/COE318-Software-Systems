...
//TODO Add instance variables (Hint: you only need 2!)
    ...
    private double actualVoltage = 0;
...
//FIXED THIS
        if (voltage >= -50 && voltage <= 50){
            ...
            System.out.println("ERROR! The voltage value must be between -50 and 50 volts!");
        }
    }
...
//FIXED THIS
        return actualVoltage / actualResistance;
    }
...
//FIXED THIS
        ...
        if (current >= -5 && current <= 5){
            actualVoltage = current * actualResistance;
        } else {
            System.out.println("ERROR! The current value must be between -5 and 5 amps!");
        }
    }
...
// Power = Voltage * Current
        return actualVoltage * getCurrent();
    }
